...
flowchart TD
    ...
    subgraph POST["Post-processing"]
        direction LR
        P1["(Optional) Run<br>remove_duplicate_dialogue.py<br>clean duplicate entries<br>in dialogue sheet (Only for Excel file)"]:::process
...
After cloning this repository and executing some codes, there should be a transcript inside the [draft folder](../draft/).<br>
The transcript file will be in either Excel or ".xliff" format.<br>
For Excel, You can simply start adding translations in the translation column.<br>
The .xliff file is supported by many CAT softwares, including the free OmegaT.<br>
