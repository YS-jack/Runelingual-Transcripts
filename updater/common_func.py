...
LANG = ['pt_br', 'no', 'es_ag', 'ja'] # add language codes here to add new language, then use update_nonEn_transcripts.py (and update_char_images.py if its non alphabet characters)
