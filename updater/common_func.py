...
LANG = ['pt_br', 'no', 'es', 'ja', 'ru', 'tr'] # add language codes here to add new language, then use update_nonEn_transcripts.py (and update_char_images.py if its non alphabet characters)
LANG_CODE_STANDARD = ['pt-BR', 'no', 'es', 'ja', 'ru', 'tr'] #  language codes follow the ISO 639 standard
